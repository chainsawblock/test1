...
export function NotificationsButton() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <Bell size={18} className="text-[var(--header-fg)]" />
        {unread > 0 && (
          <span
      ...
      {open && (
        <div
          className="absolute right-0 mt-2 w-[24rem] max-h-[70vh] overflow-auto
        ...
        >
          <div className="flex items-center justify-between px-3 py-2 border-b border-[var(--border)]/60">
            <div className="text-sm opacity-80">Уведомления</div>
            <button
